...
import com.hibiscusmc.hmcpets.api.registry.*;
...
public abstract class HMCPets extends JavaPlugin {
    ...
    @Getter
    private final PetTypeRegistry petTypeRegistry = new PetTypeRegistry();
    @Getter
    private final ActionTypeRegistry actionTypeRegistry = new ActionTypeRegistry();
    @Getter
    private final CollarTypeRegistry collarTypeRegistry = new CollarTypeRegistry();
    @Getter
    private final PetRarityRegistry petRarityRegistry = new PetRarityRegistry();
    @Getter
    private final MobTypeRegistry mobTypeRegistry = new MobTypeRegistry();
